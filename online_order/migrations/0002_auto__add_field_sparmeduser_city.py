...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SparmedUser.city'
        db.add_column(u'online_order_sparmeduser', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=255, default='KBH'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SparmedUser.city'
        db.delete_column(u'online_order_sparmeduser', 'city')
