...
class SparmedUserAdmin(UserAdmin):
    ...
    add_fieldsets = (
        (None, {
            'description': (
                _("Enter the new user's name and email address and click save. The user will be emailed a link allowing them to login to the site and set their password.")
            ),
            'fields': ('email', 'name',),
        }),
        (_('Password'), {
            'description': _("Optionally, you may set the user's password here."),
