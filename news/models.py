...
class NewsPost(models.Model):
  ...
  content = models.TextField(verbose_name="Write your news post here (Please do not attempt to insert images here, instead use the news image below)", blank=True, null=True)
